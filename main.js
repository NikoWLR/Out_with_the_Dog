...
var tiles = L.tileLayer(
  "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=insert your own access token here",
  {
    maxZoom: 18,
    attribution:
...
function onEachFeature(feature, layer) {
  var popupContent =
    "- " + feature.properties.Id + "<br>" + "- " + feature.properties.Koko;
...
var randomcoords = [
  [
    [60.44300547281816, 22.28869020938873],
    [60.443307139234584, 22.290948629379272],
  ],
  [
    [60.58663338, 22.3682834],
    [60.46146647, 22.19949567],
  ],
  [
    [60.65926926, 22.43304107],
    [60.53992979, 22.32789765],
  ],
  [
    [60.41315897, 22.29718845],
    [60.3861675, 22.20784445],
  ],
  [
    [60.44703804494439, 22.28835493326187],
    [60.447154463477325, 22.28892892599106],
  ],
];
...
//console.log(randArr)
var randArrStart = randArr[0]; //lat. coords of the chosen array
var randArrEnd = randArr[1]; //long. coords of the chosen array
...
var start = randArrStart;
var end = randArrEnd;

//Adds the start and end nodes to the map
var startmarker = L.marker(start, { icon: DogIcon }).addTo(map);
var endmarker = L.marker(end, { icon: DogIcon, draggable: true }).addTo(map);

//Creates a variable for the GeoJson pathfinding variable
var pathFinder = new geojsonPathFinder(digitie, { precicion: 1 });
...
polyline = new L.Polyline(correctCoords, polylineOptions)
  .bindPopup("Route length: " + Math.round(pathlength * 100) / 100 + " km")
  .addTo(map);
...
var stateChangingButton = L.easyButton(
  '<img src="Icons/HeckinLines.png" style="width:16px", "height:16px">',
  {
    states: [
      {
...
var SNiemiRanta = L.marker([60.425599, 22.0972503], { icon: BeachIcon }).addTo(
  map
); // Saarronniemen koiraranta
var SNiemiPuisto = L.marker([60.425766, 22.096746], { icon: BeachIcon }).addTo(
  map
); // Saarronniemen koirapuisto
var UittamoRanta = L.marker([60.4203257, 22.2508475], {
  icon: BeachIcon,
}).addTo(map); //  Uittamon koiraranta

var trashtest = L.marker([60.44300547281816, 22.28869020938873], {
  icon: TrashIcon,
}).addTo(map); //  Uittamon koiraranta
